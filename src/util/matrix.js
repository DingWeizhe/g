...
const mat3 = require('gl-matrix-node/dist/src/gl-matrix/mat3');
const vec3 = require('gl-matrix-node/dist/src/gl-matrix/vec3');
const vec2 = require('gl-matrix-node/dist/src/gl-matrix/vec2');
